...
This class diagram represents the application architecture implemented in Sprint 4. The group project begins with this architecture already implemented.

Teams may extend the design with additional services or components if new features require it, but the existing architectural structure should remain intact.

The diagram illustrates the major classes and relationships used to support task management, service logic, and dependency injection.
