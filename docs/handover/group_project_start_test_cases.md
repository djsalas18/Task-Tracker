...
These test cases represent the validation scenarios developed throughout Sprints 1–4 of the Task Tracker project. They are designed to verify the behavior of the API, user interface, and application services.

The group project begins with these test cases already implemented as part of the existing test suite.

Teams will extend the test suite by adding additional test cases for any new features or enhancements introduced during the group project.

Students should ensure that new functionality is supported by appropriate automated tests and documented test results.
