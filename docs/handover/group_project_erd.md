# Group Project - Task Tracker ERD

This ERD represents the database schema implemented in Sprint 4.
The group project begins with this schema already implemented.
Teams may extend the schema if new features require it.
