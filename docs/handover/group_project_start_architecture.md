...
This architecture diagram represents the application structure implemented in Sprint 4. The group project begins with this architecture already implemented.

Teams may extend the system with additional services or integrations if new features require it, but the core layered architecture should remain intact.

The diagram highlights the interaction between the user interface, Flask routes, service layer, repository layer, and database.
