...
def test_delete_task_success():
    ...
    # Add a task first
    new_task = service.add_task("Delete Me", "low","Task to be deleted")
    task_id = new_task["id"]
    ...
    assert deleted_task["priority"] == "low", "Returned task should have the correct priority"
...
def test_delete_task_from_multiple_tasks():
    ...
    # Add multiple tasks
    task1 = service.add_task("Keep Me", "high","This task should remain")
    task2 = service.add_task("Delete Me", "low","This task should be deleted")
    task3 = service.add_task("Also Keep", "medium","This task should also remain")
...
def test_delete_already_deleted_task():
    ...
    new_task = service.add_task("Delete Twice", "low", "Try to delete this twice")
    task_id = new_task["id"]
